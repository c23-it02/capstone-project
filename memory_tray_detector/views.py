...
# Membuka IP camera berdasarkan ID instance Camera untuk ssd
camera_open = False
@login_required(login_url='login')
...
# Membuka IP camera berdasarkan ID instance Camera untuk hdd
    ...
    if request.method == 'GET':
        ...
        if not camera_open_hdd:
            try:
                ...
                open_camera_hdd(save_folder, camera_id)
